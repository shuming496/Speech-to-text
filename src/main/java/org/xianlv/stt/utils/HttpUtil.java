...
public class HttpUtil {
    ...
    public static HttpResponse sendPost(String url, String body, String ak_id, String ak_secret) {
        ...
        try {
            ...
            System.out.println("post response status code: ["+response.getStatus()+"], response message : ["+response.getMessage()+"] ,result :["+response.getResult()+"]");
    ...
    public static HttpResponse sendGet(String url, String task_id,String ak_id, String ak_secret) {
        ...
        try {
            ...
            System.out.println("get response status code: ["+response.getStatus()+"], response message : ["+response.getMessage()+"] ,result :["+response.getResult()+"]");
